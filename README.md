...
Public Instagram reference used only for brand identity and event inspiration: https://www.instagram.com/startup.vit/

## Features

- Premium dark/light startup UI with the Startup Club SC logo
- Official `@startup.vit` identity reflected without copying follower, post, or highlight counts
